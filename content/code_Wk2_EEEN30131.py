...
from code_Wk1_EEEN30131 import get_Ybus
import math
...
def develop_PQ_V05(txt, bus1, Ybus, Bus_Data, Gflg, Bflg, Nxt, flg=False, Prnt=True):
    ...
    for bus2 in range(len(Ybus)):
        ...
        scv1, scs1, sc1 = develop_𝜃(txt, Bus_Data, 1, bus1, bus2, 𝜃s1, 𝜃v1, 𝜃f1, 𝜃s2, 𝜃v2, 𝜃f2)
        scv2, scs2, sc2 = develop_𝜃(txt, Bus_Data, 3, bus1, bus2, 𝜃s1, 𝜃v1, 𝜃f1, 𝜃s2, 𝜃v2, 𝜃f2)
